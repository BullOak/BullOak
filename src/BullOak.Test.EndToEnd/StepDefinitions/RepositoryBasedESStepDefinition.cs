namespace BullOak.Test.EndToEnd.StepDefinitions
{
    ...
    internal class RepositoryBasedESStepDefinition
    {
        ...
        {
            CinemaRepo[CinemaId].FirstOrDefault().Item1.Event.Should().NotBeNull();
            CinemaRepo[CinemaId].FirstOrDefault().Item1.Event.Should().BeAssignableTo<CinemaCreated>();
        }
        ...
        public void ThenTheCinemaCreationEventShouldHaveSeatsSetTo(int capacity)
        {
            ...
            CinemaRepo[CinemaId].FirstOrDefault().Item1.Event.As<CinemaCreated>()
