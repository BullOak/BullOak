...
#line hidden
	...
	I want the current session to have a flag informing me if this is a new entity or pre-existing", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("When I load a stream I want to know if it represents a new or existing entity", exampleTags);
#line 6
